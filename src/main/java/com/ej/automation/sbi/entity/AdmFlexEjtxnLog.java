...
@Entity
@Table(name="ADM_FLEX_EJTXN_LOG")
public class AdmFlexEjtxnLog implements Serializable{
    ...
    @Column(name ="AFE_TERM_ID")
    private String afeTermId;
    ...
    public String getAfeTermId() {
        return afeTermId;
    }

    public void setAfeTermId(final String afeTermId) {
        this.afeTermId = afeTermId;
    }

...
public class HitachiProcessor {
	...
	public HitachiProcessor(File sourceFile, String terminalName, String terminalID, String maker, String splitterJobPath, String bankID) {
